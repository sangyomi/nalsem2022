...
Goal_x = [35.041688, 35.041765, 35.0416781, 35.0417331,  35.0416326]
Goal_y = [128.3473334, 128.3473192, 128.3473759, 128.3473534, 128.347374]

#Goal_x = [35.0414606, 35.0414647]
#Goal_y = [128.3778191, 128.3778505]
...
def Goal(Goal_x, Goal_y, i):
    ...
    if ang > 180:
        ...
        if move < 5 + G:
            ...
            M.motor_move(115 + move*0.8, 80 - move*0.8)
        else:
            M.motor_move(170, 30)
        ...
        if move < 5 + G:
            ...
            M.motor_move(80 - move*0.8, 115 + move*0.8)
        else: 
            M.motor_move(30, 170)
