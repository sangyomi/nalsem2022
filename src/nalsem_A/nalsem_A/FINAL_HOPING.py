...
Goal_x = [35.0417679, 35.0417356, 35.0416927, 35.0416742,  35.0416236]
Goal_y = [128.3473205, 128.3473537, 128.3473267, 128.347381, 128.3473771]
...
def Goal(Goal_x, Goal_y, i):
    ...
    if ang > 180:
        ...
        if move < 5 + G:
            ...
            M.motor_move(135 + move*0.6, 80 - move*0.8)
        else:
            M.motor_move(160, 55)
        ...
        if move < 5 + G:
            ...
            M.motor_move(80 - move*0.8, 135 + move*0.6)
        else: 
            M.motor_move(55, 160)
